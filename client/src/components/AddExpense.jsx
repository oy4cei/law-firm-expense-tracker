...
export default function AddExpense() {
    ...
    return (
        <div className="max-w-2xl mx-auto bg-white shadow rounded-lg p-6">
            <h2 className="text-2xl font-bold mb-6 text-gray-900">Додати нову витрату</h2>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="Meals">Харчування</option>
                        <option value="Office Supplies">Канцтовари</option>
                        <option value="Legal Services">Юридичні послуги</option>
